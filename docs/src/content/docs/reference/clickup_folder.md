...
* [clickup folder create](/clickup-cli/reference/clickup_folder_create/)	 - Create a new folder
* [clickup folder delete](/clickup-cli/reference/clickup_folder_delete/)	 - Delete a folder
