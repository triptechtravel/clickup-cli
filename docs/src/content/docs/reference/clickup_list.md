...
* [clickup list create](/clickup-cli/reference/clickup_list_create/)	 - Create a new list
* [clickup list delete](/clickup-cli/reference/clickup_list_delete/)	 - Delete a list
